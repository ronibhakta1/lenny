...
LCP_PORT="${LCP_PORT:-8081}"
LCP_SERVER_URL="${LCP_SERVER_URL:-http://localhost:$LCP_PORT}"
LCP_SERVER_ADMIN_USER="${LCP_SERVER_ADMIN_USER:-$(genpass 16)}"
LCP_SERVER_ADMIN_PASSWORD="${LCP_SERVER_ADMIN_PASSWORD:-$(genpass 32)}"
...
LCP_SERVER_ADMIN_USER=$LCP_SERVER_ADMIN_USER
LCP_SERVER_ADMIN_PASSWORD=$LCP_SERVER_ADMIN_PASSWORD
